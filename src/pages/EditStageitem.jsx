...
// import { updateStageItemwiseAPI } from '../services/allAPI';
...
//       }
//       try{
//         const result = await updateStageItemwiseAPI(id,reqBody,reqHeader)
  ...
  useEffect(() => {
    const fetchItemDetails = async () => {
      ...
      if (token && id) {
        ...
        try {
          const result = await addStageItemwiseAPI(id, reqHeader);
          if (result.status === 200) {
