...
export default function TamilKalaivizhaDashboard() {
  ...
  const handleFestivalChange = (e) => {
    ...
    setSelectedCategory(null); // Reset selected category when changing festival
    setSelectedColumn(null); // Reset selected column when changing festival
    ...
    if (newFestival === "Status View" && 
        selectedResultType !== "All Result" && 
        selectedResultType !== "Status of Festival") {
      setSelectedResultType("All Result");
    }
  };

  const handleResultTypeChange = (e) => {
    setSelectedResultType(e.target.value);
    setSelectedCategory(null); // Reset selected category when changing result type
    setSelectedColumn(null); // Reset selected column when changing result type
  };
