...
const AddTabulationSheet = () => {
    const [callsheet, setCallsheet] = useState({
        Festival: "", Item: "", Session: ""
    })
    ...
    const handleAddTabulationSheet = async (e) => {
        e.preventDefault();
        const { Festival, Item, Session } = callsheet
        if (Festival && Item && Session) {
            // alert("proceed to api")
            const reqBody = new FormData()
            reqBody.append("Festival", Festival)
            reqBody.append("Item", Item)
            reqBody.append("Session", Session)
            ...
            if (token) {
                ...
                try {
                    ...
                    if (result.status === 200) {
                        ...
                        setCallsheet({ Festival: "", Item: "", Session: "" })
                    } else {
                                ...
                                <div className="space-y-4 ">
                                    ...
                                    <div className='text-center mt-10'>
                                        <button
                                            ...
                                            onClick={handleAddTabulationSheet}
                                        >
                                            Report
                                        </button>
                                    </div>
...
export default AddTabulationSheet