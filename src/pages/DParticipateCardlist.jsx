...
const DParticipateCardlist = () => {
  ...
  const sampleParticipants = [
    { id: 1, regNo: "2", name: "Riyashree S", itemname: " Mono Act", itemcode: "301", class: "9", schoolCode: "30003", schoolName: "-G. H. S. S. Vaguvuurai", subDistrict: "Munnar" },
    { id: 2, regNo: "23", name: "Kaviya L", itemname: " Mono Act", itemcode: "401", class: "6", schoolCode: "30003", schoolName: "-G. H. S. S. Vaguvuurai", subDistrict: "Adimali" },
    { id: 3, regNo: "11", name: "Mukila M", itemname: " Mono Act", itemcode: "501", class: "9", schoolCode: "30003", schoolName: "-G. H. S. S. Vaguvuurai", subDistrict: "Kattappana" },
  ...
  const handleSearchChange = (event) => {
    ...
    filterParticipants(newSearchTerm, selectedSubDistrict, selectedFestival);
  ...
  const handleSubDistrictChange = (event) => {
    ...
    filterParticipants(searchTerm, newSubDistrict, selectedFestival);
  ...
  const handleFestivalChange = (event) => {
    ...
    filterParticipants(searchTerm, selectedSubDistrict, newFestival);
    setCurrentPage(1); // Reset to first page when filtering
  };

  // Combined filtering function
  const filterParticipants = (term = searchTerm, subDistrict = selectedSubDistrict, festival = selectedFestival) => {
                ...
                <div style={styles.rightSection}>
                  {isLandscape && (
                    <>
                      ...
                      <div style={styles.cardSchool}>
                        Idukki Revenue District SGHSS, {participant.subDistrict}
                      </div>
                    </>
                  )}
 ...
 export default DParticipateCardlist