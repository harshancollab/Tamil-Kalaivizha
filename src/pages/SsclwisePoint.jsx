...
const SsclwisePoint = () => {
    ...
    // Filter data whenever selectedFestival, allResultData, or district filters change
    useEffect(() => {
        if (allResultData.length > 0) {
            filterData();
        }
    }, [selectedFestival, allResultData, selectedDistrict, selectedSubDistrict]);
    ...
    const getPrintTitle = () => {
        ...
        switch (selectedFestival) {
            case "UP Kalaivizha":
                title = "UP Tamil Kalaivizha";
                break;
            case "LP Kalaivizha":
                title = "LP Tamil Kalaivizha";
                break;
            case "HS Kalaivizha":
                title = "HS Tamil Kalaivizha";
                break;
            case "HSS Kalaivizha":
                title = "HSS Tamil Kalaivizha";
                break;
            case "All Festival":
                title = "All Festival Tamil Kalaivizha";
                break;
            default:
                title = "Tamil Kalaivizha";
        }
        ...
        return `${title} - School Wise Point Report`;
    };
    ...
    const generatePDF = () => {
        ...
        // PDF filename with district and sub-district info if selected
        let fileNameParts = [selectedFestival.replace(/ /g, '_')];
        ...
        const fileName = `${fileNameParts.join('_')}_School_Wise_Points.pdf`;
