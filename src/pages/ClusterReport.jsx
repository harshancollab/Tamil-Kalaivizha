        ...
        <>
            ...
            <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
                ...
                <div className="flex-1 p-4 md:p-6 mt-4 w-full overflow-x-auto">
                    <h2 className="text-lg font-semibold mb-4">Cluster Report</h2>

                    <div className="space-y-6">
                        {/* Call Sheet (Item) */}
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4">Cluster report (Item)</h3>
                            <form onSubmit={handleAddcallsheet}>
                                <div className="flex justify-center">
                                    <div className="space-y-4 w-full max-w-md">
                                        ...
                                        <button
                                                type="submit"
                                                className="border border-blue-500 text-blue-600 px-4 md:px-6 py-2 md:py-3 rounded-full mt-4 mr-5"
                                            >
                                               Press Report
                                            </button>
                                            <button
                        ...
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4">Cluster report (Festival Wise)</h3>
                        ...
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4">Cluster report (Date & Stage Wise)</h3>
...
// import Header from '../components/Header'
// import Dash from '../components/Dash'
// import { getClusterReportAPI, fetchClusterDataAPI } from '../services/allAPI' // You'll need to create these API functions
...
//     // Sample call sheet data (this will be replaced with API data)
//     const callSheetData = [
//         { slNo: 1, registerNo: '17', cluster: 1, codeNo: '', signOfParticipants: '', remarks: '' },
//         { slNo: 2, registerNo: '190', cluster: 1, codeNo: '', signOfParticipants: '', remarks: '' },
//         { slNo: 3, registerNo: '149', cluster: 1, codeNo: '', signOfParticipants: '', remarks: '' },
...
//             };
//             try {
//                 const result = await fetchClusterDataAPI(reqHeader);
//                 if (result.status === 200) {
//                     setClusterData(result.data);
//                     setTotalParticipants(result.data.length || 0);
//                 }
//             } catch (err) {
//                 console.log(err);
//                 setError("Failed to fetch cluster data. Please try again.");
//             } finally {
//                 setLoading(false);
//             }
//         } else {
...
//                 };
//                 try {
//                     const result = await getClusterReportAPI(reqBody, reqHeaders);
//                     if (result.status === 200) {
//                         // Update the cluster data with the new report
//                         setClusterData(result.data);
//                         // Print the call sheet after successful API response
//                         handlePrint("item", `${Festival} - ${Item}`);
//                         setItemCallsheet({ Festival: "", Item: "" });
//                     } else {
//                         setError(result.response?.data || "An error occurred while generating the report");
//                     }
//                 } catch (err) {
//                     console.log(err);
...
//     // Function for festival-wise report
//     const handleFestivalReport = async (e) => {
//         e.preventDefault();
//         if (festivalCallsheet.Festival) {
//             setLoading(true);
//             setError(null);
...
//             if (token) {
//                 const reqBody = new FormData();
//                 reqBody.append("Festival", festivalCallsheet.Festival);
//                 const reqHeaders = {
//                     "Authorization": `Bearer ${token}`
//                 };
//                 try {
...
//     // Function for date & stage report
//     const handleDateStageReport = async (e) => {
//         e.preventDefault();
//         if (dateStageCallsheet.Date && dateStageCallsheet.Stage) {
//             setLoading(true);
//             setError(null);
...
//             if (token) {
//                 const reqBody = new FormData();
//                 reqBody.append("Date", dateStageCallsheet.Date);
//                 reqBody.append("Stage", dateStageCallsheet.Stage);
//                 const reqHeaders = {
//                     "Authorization": `Bearer ${token}`
//                 };
//                 try {
...
//             }
//         } else {
//             setError("Please select date and stage");
//         }
//     };
...
//         // Use API data for table if available, otherwise use sample data
//         const dataToUse = clusterData.length > 0 ? clusterData : callSheetData;
...
//             <div class="footer-info">
//                 <div class="footer-item">
//                     <p>No of Participants Registered : ${totalParticipants}</p>
//                     <p>No of Participants Performed : </p>
//                     <p>No of Participants Reported : </p>
//                 </div>
//                 <div class="footer-signature">
