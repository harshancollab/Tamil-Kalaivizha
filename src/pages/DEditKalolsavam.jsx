              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center">
                  ...
                  <input
                    ...
                    type="text"
                    name="kalolsavamName"
                    className="w-full sm:max-w-md sm:ml-10 border border-gray-600 px-4 sm:px-6 py-2 rounded-full bg-gray-200"
...
export default DEditKalolsavam