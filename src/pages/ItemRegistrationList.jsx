...
// import { deleteItemAPI, getAllitemAPI } from '../services/allAPI';
...
//             try {
//                 setLoading(true);
//                 // Pass the page and limit parameters to the API
//                 const result = await getAllitemAPI(currentPage, rowsPerPage, reqHeader);
//                 if (result.status === 200) {
//                     setItems(result.data.items || result.data);
//                     setTotalItems(result.data.totalItems || result.data.length);
...
//                             <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-blue-500 border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"></div>
//                             <p className="ml-2 text-gray-600">Loading items...</p>
//                         </div>
//                     ) : (
//                         <div className="w-full">
//                             <div id="print-container" className="overflow-x-auto -mx-4 sm:mx-0">
...
//                                                 {currentItems.length > 0 ? (
//                                                     currentItems.map((item, index) => (
//                                                         <tr key={item.slNo || index} className="hover:bg-gray-100">
//                                                             <td className="p-2 md:p-3 whitespace-nowrap">{indexOfFirstItem + index + 1}</td>
//                                                             <td className="p-2 md:p-3 whitespace-nowrap">{item.code}-{item.item}</td>
//                                                             <td className="p-2 md:p-3 whitespace-nowrap">{item.itemType}</td>
//                                                             <td className="p-2 md:p-3 whitespace-nowrap">{item.noOfStudents}</td>
...
//                                                             <td className="p-2 md:p-3 whitespace-nowrap">
//                                                                 <button
//                                                                     onClick={() => handleDeleteClick(item.slNo || item._id)}
//                                                                     className="text-red-600 hover:text-red-800 focus:outline-none"
//                                                                 >
//                                                                     <i className="fa-solid fa-trash cursor-pointer"></i>
//                                                                 </button>
