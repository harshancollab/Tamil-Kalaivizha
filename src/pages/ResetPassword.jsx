...
const ResetPassword = () => {
    ...
    if (validateEmail()) {
      ...
      try {
        ...
        if (result && result.status === 200) {
          ...
          // Navigate after a short delay to ensure the alert is visible
          setTimeout(() => {
            navigate("/otp-verification");
          }, 1500);
        } else {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 relative">
      {/* Alert positioned absolutely within the container */}
      {alert.show && (
      ...
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-4xl mx-4">
        {/* Image */}
        <div className="w-1/2 hidden md:block">
          <img
            src="https://www.evangelismcoach.org/wp-content/uploads/Church-Hospitality-AuditS_no_text-1024x1024.jpg"
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="bg-white p-6 md:p-10 rounded-2xl shadow-lg w-full max-w-md">
            <h2 className="text-2xl font-semibold text-gray-800 text-center">
              Forgot Password
            </h2>
            <p className="text-gray-600 text-center mt-2">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mt-6">
                ...
                <input
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className={`w-full px-4 py-3 border rounded-full shadow-sm focus:outline-none focus:ring-2 ${
