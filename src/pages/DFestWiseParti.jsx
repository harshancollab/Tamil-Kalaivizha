// District - sub Festivelwisearticipate
...
const DFestWiseParti = () => {
    ...
    const dummyData = [
        ...
        { regNo: "601", name: "Nithin Rajan", gender: "Boy", class: "12", schoolCode: "004", schoolName: "Sacred Heart HSS Thrissur", itemCode: "302", subDistrict: "Nedumkandam" },
        { regNo: "3001", name: "Kavya Mohan", gender: "girl", class: "5", schoolCode: "005", schoolName: "Govt. UP School Kollam", itemCode: "602", subDistrict: "Devikulam" },
        { regNo: "401", name: "Sajeev Thomas", gender: "Boy", class: "2", schoolCode: "006", schoolName: "Little Flower LP School Alappuzha", itemCode: "402", subDistrict: "Chittur" },
        { regNo: "601", name: "Lakshmi Pillai", gender: "girl", class: "11", schoolCode: "010", schoolName: "Don Bosco HSS Idukki", itemCode: "602", subDistrict: "Pattambi" },
        { regNo: "305", name: "Vijay Menon", gender: "Boy", class: "6", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "305", subDistrict: "Munnar" },
        { regNo: "306", name: "Shreya Nair", gender: "girl", class: "4", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "306", subDistrict: "Adimali" },
        { regNo: "0101", name: "Meera Suresh", gender: "girl", class: "11", schoolCode: "004", schoolName: "Sacred Heart HSS Thrissur", itemCode: "601", subDistrict: "Kattappana" },
        { regNo: "601", name: "Nithin Rajan", gender: "Boy", class: "12", schoolCode: "004", schoolName: "Sacred Heart HSS Thrissur", itemCode: "302", subDistrict: "Nedumkandam" },
        { regNo: "3001", name: "Kavya Mohan", gender: "girl", class: "5", schoolCode: "005", schoolName: "Govt. UP School Kollam", itemCode: "602", subDistrict: "Devikulam" },
        { regNo: "401", name: "Sajeev Thomas", gender: "Boy", class: "2", schoolCode: "006", schoolName: "Little Flower LP School Alappuzha", itemCode: "402", subDistrict: "Chittur" },
        { regNo: "601", name: "Lakshmi Pillai", gender: "girl", class: "11", schoolCode: "010", schoolName: "Don Bosco HSS Idukki", itemCode: "602", subDistrict: "Pattambi" },
        { regNo: "305", name: "Vijay Menon", gender: "Boy", class: "6", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "305", subDistrict: "Munnar" },
        { regNo: "306", name: "Shreya Nair", gender: "girl", class: "4", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "302", subDistrict: "Adimali" },
        { regNo: "671", name: "Meera Suresh", gender: "girl", class: "11", schoolCode: "004", schoolName: "Sacred Heart HSS Thrissur", itemCode: "302", subDistrict: "Kattappana" },
        { regNo: "771", name: "Nithin Rajan", gender: "Boy", class: "12", schoolCode: "004", schoolName: "Sacred Heart HSS Thrissur", itemCode: "302", subDistrict: "Nedumkandam" },
        { regNo: "661", name: "Kavya Mohan", gender: "girl", class: "5", schoolCode: "005", schoolName: "Govt. UP School Kollam", itemCode: "302", subDistrict: "Devikulam" },
        { regNo: "678", name: "Sajeev Thomas", gender: "Boy", class: "2", schoolCode: "006", schoolName: "Little Flower LP School Alappuzha", itemCode: "302", subDistrict: "Chittur" },
        { regNo: "444", name: "Lakshmi Pillai", gender: "girl", class: "11", schoolCode: "010", schoolName: "Don Bosco HSS Idukki", itemCode: "302", subDistrict: "Pattambi" },
        { regNo: "333", name: "Vijay Menon", gender: "Boy", class: "6", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "302", subDistrict: "Munnar" },
        { regNo: "326", name: "Shreya Nair", gender: "girl", class: "4", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "302", subDistrict: "Adimali" },
        { regNo: "326", name: "Shreya Nair", gender: "girl", class: "4", schoolCode: "001", schoolName: "Government UP School Thiruvananthapuram", itemCode: "302", subDistrict: "Kattappana" }
    ];
    ...
    }, [Alllist, selectedFestival, searchTerm, searchField, selectedItemCode, selectedSubDistrict]);
    ...
    const handleSubDistrictChange = (e) => {
        // Update URL when sub-district changes
        updateSearchParams('subDistrict', e.target.value);
        // Reset to first page when changing sub-district
        setCurrentPage(1);
    };
    ...
    const generatePDF = () => {
        ...
        titleElement.textContent = `${festivalPart} - ${subDistrictPart}${itemPart} - Participants List`;
        ...
        // PDF filename
        const fileName = `${selectedFestival.replace(/ /g, '_')}_${selectedSubDistrict.replace(/ /g, '_')}_Participants.pdf`;
                ...
                <div className="flex-1 p-4 md:p-6 lg:p-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
                        <h2 className="text-[20px] font-[700] leading-[100%] tracking-[2%]">
                            Sub District Participants List (Festival Wise)
                        </h2>
