...
//       </div>
//       {isAddModalOpen && (
//         <Addparticipat onClose={() => setIsAddModalOpen(false)} />
//       )}
//       {isEditModalOpen && (
//         <Editparticipate onClose={() => setIsEditModalOpen(false)} />
//       )}
//     </>
//   );
// };
         ...
         <div className="absolute top-3 right-3 md:top-3 md:right-3 z-10 flex items-center ">
            ...
            <div className="w-full md:w-auto">
              ...
              <div className="flex items-center gap-4 mb-3">
                <div className="flex items-center">
                  <p className="mr-2 font-semibold text-gray-600">No of Boys:  <span className=" ">40</span></p>
                
                </div>
                <div className="flex items-center">
                 <p
                  className="mr-2 font-semibold text-gray-600">No of  Girls:
