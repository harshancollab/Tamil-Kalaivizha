...
const SScoresheet = () => {
    ...
    const handlePrint = (type, title) => {
        ...
        let reportTitle = "Score Sheet";
        let stageInfo = "";
        
        if (type === "festival") {
            reportTitle = `Score Sheet - ${title} `;
        } else if (type === "dateStage") {
            const [date, stage] = title.split(" - ");
            reportTitle = `Score Sheet Tamil Kalaivizha - ${title} `;
            stageInfo = `
        ...
        <>
            ...
            <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
                ...
                <div className="flex-1 p-4 md:p-6 mt-4 w-full overflow-x-auto">
                    <h2 className="text-lg font-semibold mb-4"> Stage Report - Score Sheet</h2>

                    <div className="space-y-6">
                        {/* Call Sheet (Item) */}
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4"> Score Sheet (Item)</h3>
                        ...
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4">Score Sheet (Festival Wise)</h3>
                        ...
                        <div className="bg-gray-200 p-4 md:p-6 rounded-lg">
                            <h3 className="text-md font-semibold mb-4"> Score Sheet (Date & Stage Wise)</h3>
