        ...
        if (
            ...
            if (token) {
                ...
                try {
                    ...
                    if (result.status === 201) { // Assuming 201 Created status for successful addition
                        alert("Result entry added successfully");
                        navigate('/all-resultentry');
                    }
                } catch (err) {
                    console.log(err);
                    alert("Failed to add result entry. Please try again.");
                }
            } else {
                ...
                <div className="flex-1 p-2 md:p-2 w-full">
                    ...
                    >
                        <div className="mb-4 mt-2 md:mb-5 md:mt-3">
                            <h2 className="text-xl md:text-2xl font-semibold">Add Result Entry</h2>
                        </div>
...
export default SAddResultentry