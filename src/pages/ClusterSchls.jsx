...
const ClusterSchls = () => {
  ...
  // Simpler print function that works on mobile
  const handlePrint = () => {
    window.print();
  };
    ...
    <>
      ...
      <style type="text/css" media="print">
        {`
          ...
          header, nav, .no-print, button, input {
            display: none !important;
          }
          /* Hide the Header and Dash components */
          header, nav, aside, .sidebar {
            display: none !important;
          }
          /* Hide the Header component by its selector */
          #root > header, .header-container, header {
            display: none !important;
          }
          /* Hide the Dash/sidebar component */
          .sidebar, aside, nav {
            display: none !important;
          }
          /* Only show what's needed for printing */
          .print-content {
            display: block !important;
            width: 100% !important;
            margin: 0 !important;
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="flex-1 p-4 md:p-6 lg:p-8">
          <div className="flex justify-between items-center mb-4 no-print">
            <h2 className="text-[20px] font-[700] leading-[100%] tracking-[2%]   print-title">
              Cluster School List 
            </h2>
            <button 
              onClick={handlePrint}
          ...
          {error && (
            <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative mb-4 no-print" role="alert">
              <span className="block sm:inline">{error}</span>
            </div>
          )}
          
          <div className="relative flex mt-2 items-center w-full sm:w-64 h-9 border border-blue-800 rounded-full px-4 no-print">
            <input
              type="text"
              placeholder="Search School Code..."
              className="w-full bg-transparent outline-none text-sm"
