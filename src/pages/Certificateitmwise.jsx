...
//                                                     <td className="p-2 md:p-3 text-blue-500 whitespace-nowrap">{item.itemCode} - {item.itemName}</td>
...
const Certificateitmwise = () => {
    ...
    const handleItemClick = (itemCode, itemName) => {
        // Navigate to CertificateParticipate page with item details as URL parameters
